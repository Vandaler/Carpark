...
namespace Carpark
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int sectionNumber;
            if (Int32.TryParse(SectionBox.Text, out sectionNumber))
            {
                carSection.MarkCheckbox(sectionNumber);
            }
        }

        private void ทจอดรภToolStripMenuItem_Click(object sender, EventArgs e)
        {
            
            carSection.ShowDialog();
        }
